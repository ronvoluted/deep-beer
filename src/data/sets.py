...
def load_sets(X_train='X_train', y_train='y_train', X_val='X_val', y_val='y_val', X_test='X_test', y_test='y_test', path='../data/processed/'):
    """Load sets from local storage

    Parameters
    ----------
    X_train: str
        Name of file without extension to load for X_train
    y_train: str
        Name of file without extension to load for y_train
    X_val: str
        Name of file without extension to load for X_val
    y_val: str
        Name of file without extension to load for y_val
    X_test: str
        Name of file without extension to load for X_test
    y_test: str
        Name of file without extension to load for y_test
    path : str
        Path to the folder where the sets will be loaded from (default: '../data/processed/')
